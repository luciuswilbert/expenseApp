  ...
  Widget build(BuildContext context) {
    return PopupMenuButton<String>(
      ...
      onSelected: (String value) {
        String? currentRoute = ModalRoute.of(context)?.settings.name; // ✅ Get current route
        ...
        if (value == "Manual" && currentRoute != '/add_expense') {
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              ...
              settings: const RouteSettings(name: '/add_expense'), // ✅ Assign route name
            ),
          );
        } else if (value == "OCR (Scan the Receipt)" && currentRoute != '/ocr_add_expense') {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
        ...
        } else if (value == "AI (Voice Assistant)" && currentRoute != '/ai_voice_assistant') {
          // Navigator.pushReplacement(
          //   context,
          //   MaterialPageRoute(
      ...
      itemBuilder: (BuildContext context) => [
        ...
        _buildMenuItem("OCR (Scan the Receipt)", Icons.camera_alt, Colors.green),
        _buildMenuItem("AI (Voice Assistant)", Icons.mic, Colors.purple),
      ],
    );
  }

  PopupMenuItem<String> _buildMenuItem(String title, IconData icon, Color iconColor) {
